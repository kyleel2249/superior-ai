/**
 * JWT session helpers (Auth.js-compatible shape)
 * HS256 for dev; production should prefer asymmetric keys / JWKS from IdP.
 */
...
/** Decode IdP JWT payload without verification (preview only — use JWKS in production) */
